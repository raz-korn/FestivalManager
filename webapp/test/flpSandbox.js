		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#keepdancingfestivalmanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"keepdancingfestivalmanager-display": {
								"semanticObject": "keepdancingfestivalmanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=keepdancing.festivalmanager",
									"url": sap.ui.require.toUrl("keepdancing/festivalmanager")
								}
							}
						}
					}
